...
const BlogCreator = () => {
    ...
    return (
        <div className="wiki-blog-creator-container">
            <EditorToolBar innerEditorRef={activeEditorInnerRef} activeEditorRef={activeEditorRef} alignment={setDescriptionAlignment} activeState={activeEditor} fontSize={activeEditor === "title" ? fontTitleSize : fontDescriptionSize} setFontSize={activeEditor === 'title' ? setFontTitleSize : setFontDescriptionSize}/>
